...
@section('content')
    @if($has_voted== true)
        <div class="col-md-12 noPadding" id="app">
            <div class="col-md-12 jumbotron text-center bg-white roundedCorners fade_out">
                <img src="{{asset('/img/cosbis/cosbr-logo.png')}}" alt="" style="max-width: 200px">
                <h2 style="color: green"><b>You have already submitted your votes for this year's election! Thank you!</b></h2>
            </div>
        </div>
    @endif
    @if($has_voted== false)
        <div class="col-md-12 noPadding" id="app">
            ...
            <div class="col-md-12 bg-white roundedCorners fade_out">
                <div class="container"
                        ...
                        <ol class="panel-group list-unstyled remindersDiv" id="accordion">
                            <li class="panel panel-default" data-toggle="collapse" data-parent="#accordion"
                                ...
                                <div id="rule1" class="panel-collapse collapse in">
                                    <div class="panel-body">This year's election, as well as all of the other previous
                                        and
                                        futures elections, will determine the students that will represent your student
                                        body
                                        for an entire academic year. It is extremely important for everyone that the
                                        right
                                        people are voted in. We ask of you not to take this election lightly as this is
                                        our
                            ...
                            <li class="panel panel-default" data-toggle="collapse" data-parent="#accordion"
                                ...
                                <div id="rule2" class="panel-collapse collapse in">
                                    <div class="panel-body">In order to preserve each and everyone's privacy, the
                                        student
                                        council organization and the office of student affairs will not use any
                                        information
                            ...
                            <li class="panel panel-default" data-toggle="collapse" data-parent="#accordion"
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a>
                                            You are allowed to skip a vote. Although we strongly advise you not to</a>
                                    </h4>
                                </div>
                                <div id="rule3" class="panel-collapse collapse in">
                                    <div class="panel-body">It is within your rights as voter and student to choose only
                                        the
                                        candidates you are confident with. That being said, it is also beneficial for
                                        the
                                        school and the entire student body, if students would not skip votes and take
                                        time
                                        to get to know each candidates. We do hope that you complete your ballot before
                                        submitting it to us.
                                    </div>
                                </div>
                            </li>
                            <li class="panel panel-default" data-toggle="collapse" data-parent="#accordion"
                                ...
                                <div id="rule4" class="panel-collapse collapse in">
                                    <div class="panel-body">Lastly, we would like everyone to take their time in
                                        completing
                                        their ballots. Once you have entered your votes, there will be no chance of
                                        change
                                        your ballot. It is very important that you have carefully reviewed and reread
                                        your
            ...
            <div class="col-md-12 fade_out" style="margin-top: 20px;">
                <div class="container text-center" style="border:none">
                    <button class="btn btn-success" @click="start()">Start Voting</button>
                </div>
            </div>

            <div class="col-md-12 voting_form noPadding" style="display: none">
                    ...
                    <div class="container" style="max-width: 100%; border: none; height: 100%">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                ...
                                <h5 style="color: red" v-if="ballot.president.id==null"><b>President: None Selected</b>
                                </h5>
                                ...
                                <h5 style="color: green" v-if="ballot.vp_activities.id!=null"><b>VP Activities: @{{
                                        ballot.vp_activities.name }}</b></h5><h5 style="color: red"
                                                                                 v-if="ballot.vp_activities.id==null">
                                    <b>VP
                                        Activities: None
                                        Selected</b>
                                </h5>
                                <h5 style="color: green" v-if="ballot.vp_academics.id!=null"><b>VP Academics: @{{
                                        ...
                                        }}</b></h5><h5 style="color: red" v-if="ballot.vp_academics.id==null"><b>VP
                                        Academics: None
                                        Selected</b></h5>
                                <h5 style="color: green" v-if="ballot.vp_finance.id!=null"><b>VP Finance: @{{
                                        ballot.vp_finance.name
                                        }}</b></h5><h5 style="color: red" v-if="ballot.vp_finance.id==null"><b>VP
                                        Finance:
                                        None Selected </b>
                                </h5>
                                <h5 style="color: green" v-if="ballot.secretary.id!=null"><b>Secretary: @{{
                                        ballot.secretary.name }} </b><h5 style="color: red"
                                                                         v-if="ballot.secretary.id==null"><b>Secretary:
                                            None
                                            Selected </b>
                                    </h5>
                                </h5>
                ...
                <div class="col-md-12 bg-white roundedCorners">
                    <div class="container" style="max-width: 100%; border:none; height: 100%">
                        ...
                        <hr>
                        <div class="col-md-5 col-md-offset-1">
                            <h5 style="color: green"><b style="color: black">Title:</b> @{{
                                position_details.title[page-1]
                                }}</h5>
                ...
                <div class="col-md-12 bg-white roundedCorners">
                    <div class="container" style="max-width: 100%; border:none; height: 100%;">
                        ...
                        <ol>
                                ...
                                <li style="font-size: 2em">
                                    ...
                                    <div class="col-md-12 noPadding">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <h5><b>Name:</b> @{{ candidate.user.firstname + ' ' +
                            ...
                            <div class="col-md-12 roundedCorners">
                                <li style="font-size: 2em" @click="skipVote()">
                                    <h2 style="color: red" class="pointerOnHover"><b><span
                                                    class="glyphicon glyphicon-exclamation-sign"></span>Skip this
                                            position (Remove my pending vote for this position).</b></h2>
                                </li>
                            </div>
                        </ol>
                    </div>
                ...
                <div class="col-md-2 col-md-offset-5">
                    ...
                    <button class="btn btn-success" v-if="page==6" data-toggle="modal" data-target="#myModal">Submit
                    </button>
                </div>
            </div>
            <form action="/election/vote" method="post" id="ballotForm">
                {{csrf_field()}}

                <input type="hidden" name="president" v-model="ballot.president.id">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h3 class="modal-title" style="color: green"><b>Ballot Summary!</b></h3>
                        </div>
                        <div class="modal-body">
                            <label for="">You have completed your ballot for the College of San Benildo - Rizal
                                Election {{now()->year}}. You can still go back to make changes to your ballot. Now is
                                the
                                time to make any changes if there are any mistakes with your ballot. Please check your
                                ballot summary below:</label>
                            <hr>
                            ...
                            <h5 style="color: green" v-if="ballot.vp_activities.id!=null"><b>VP Activities: @{{
                                    ballot.vp_activities.name }}</b></h5><h5 style="color: red"
                                                                             v-if="ballot.vp_activities.id==null"><b>VP
                                    Activities: None
                                    Selected</b>
                            </h5>
                            <h5 style="color: green" v-if="ballot.vp_academics.id!=null"><b>VP Academics: @{{
                            ...
                            <h5 style="color: green" v-if="ballot.vp_finance.id!=null"><b>VP Finance: @{{
                                    ballot.vp_finance.name
                                    }}</b></h5><h5 style="color: red" v-if="ballot.vp_finance.id==null"><b>VP Finance:
                                    None
                                    Selected </b>
                            </h5>
                            <h5 style="color: green" v-if="ballot.secretary.id!=null"><b>Secretary: @{{
                        ...
                        <div class="modal-footer">
                            <label type="submit" class="btn btn-success pointerOnHover"
                                   @click="submitBallot()">Submit</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            var Main = {
                ...
                methods: {
                    ...
                    move_page: function (direction) {
                        $('.candidate_cubes').css({'opacity': '0'});
                        setTimeout(function(){
                            $('.candidate_cubes').css({'opacity': '1'});
                    ...
                    skipVote: function () {
                        this.ballot[this.positions[this.page - 1]].id = null;
                        this.ballot[this.positions[this.page - 1]].name = null;
                        this.move_page('next');
                    },
                    submitBallot: function () {
                        var ballot = this.ballot;
                        if (this.positions.filter(function (position) {
                                return ballot[position].id != null
                            }).length > 0)
                            document.getElementById('ballotForm').submit();
                        else
                            this.$notify.error({
                                title: 'Empty Ballot!',
                                message: 'Please Do Not Send an Empty Ballot',
                            });
                    }
                }
            }
