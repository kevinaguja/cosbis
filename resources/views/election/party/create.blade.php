...
@section('content')
    <div class="col-md-12" style="border:none; max-width: 100%;">
        <form action="/election/parties/create" method="post" enctype="multipart/form-data">
            ...
            <div class="container noPadding" style="max-width: 100%; border: none">
                <div class="col-md-12 header noPadding img-responsive text-center" style="background-color: #555">
                    <img id="imgBanner" name="banner" src="{{asset('img/elections/parties/banners/default.png')}}" alt="party banner" style="width: auto; max-width: 100%; max-height: 800px">
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-5">
                            <div class="col-md-8 col-md-offset-2 text-center">
                                <img src="{{asset('img/elections/parties/logos/default.png')}}" class="img-responsive" id="imgLogo"  alt="Party Logo">
                            </div>
                        </div>
                    </div>
